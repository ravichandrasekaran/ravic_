...
6. "Conducting power analysis before data collection avoids wasting resources and assesses the information value of your design in case of null results.I have made a list of easy-to-use tools for power analysis. Maybe it is useful to some of you. https://t.co/7gQMKG5jzf. https://t.co/29fW18Efhv," --kunkakom [Jun 11](https://twitter.com/172942846/status/1403285476023414787)
3. "Really excited to share this ecology paper as a glorious example of how to properly interpret (and not over interpret) the inference from a regression model, https://t.co/zSgRHtb8p0.  I helped with the model but that careful interpretation was all @fsdias8.," --betanalpha [2021-06-11](https://twitter.com/78196808/status/1403149659502227456)
7. "So you think you know distillation; it's easy, right?We thought so too with @XiaohuaZhai @__kolesnikov__ @_arohan_ and the amazing @royaleerieme and Larisa Markeeva.Until we didn't. But now we do again. Hop on for a ride (+the best ever ResNet50?)🧵👇https://t.co/3SlkXVZcG3 https://t.co/Qp5qiZzV14," --giffmana [2021-06-10](https://twitter.com/2236047510/status/1402836863954599936)
25. "Introducing MERLOT: a new model that learns about language, vision, &amp; the world from 6M YouTube videos.Out-of-the-box, MERLOT has intrinsic notions of multimodal temporal commonsense. When finetuned, we get SOTA performance on 12 video tasks + VCR. https://t.co/2H6ng2Yfxt https://t.co/oMPPtOjLBm," --rown [2021-06-07](https://twitter.com/17108894/status/1401980209876783109)
30. "Gramformer a framework for detecting, highlighting and correcting grammatical errors on natural language text. It's like Grammarly but it's free! Don't forget to spend some star love for the repository!https://t.co/PI0J6zP7Vw https://t.co/7HxuQDDSDA," --philipvollet [2021-06-07](https://twitter.com/421795636/status/1401809727294611466)
...
13. "Why? Because the second hint never makes you *want* to change your decision. (Think about the four possible hint combinations.)This is a key idea behind a beautiful paper by Meg Meyer, here: 2/ https://t.co/z1C8cDxloe," --ben_golub [2021-06-10](https://twitter.com/314734325/status/1402781286067023875)
...
1. "The problem with workload (and thus work-life balance) in academia is: You can always do more.(A thread based on a recent personal epiphany.)," --cfiesler [2021-06-09 14:33:19](https://twitter.com/194203770/status/1402634919516512259)
