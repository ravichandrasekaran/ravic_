...
#### Answer
**Sit in the last row!** You've got a 6.37% chance of getting the t-shirt!
...
probability of the t-shirt arriving in row $R$. There's a little weirdness
at the edges:
...
est_plt <- est_probs %>%
  ...
  geom_text_repel(data = (
    est_probs %>%
      filter(r == 1) %>%
      mutate(prob_label = "Row 1 catches extra zero-distance throws")),
    aes(label = prob_label),
    size = 3, nudge_x = 6, nudge_y = .005, hjust=0)
