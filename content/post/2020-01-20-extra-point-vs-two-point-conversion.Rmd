...
that will give us the threshold at which we should change tacks, $p_{XP} = 0.8$.
...
**So, defend against the two-point conversion until we the offense is going
to go for the extra point with at least a 80% probability.**
