...
& = [\frac{c}{2} + (1-c)]^4 - (1 - c)^4 \\
& = [1 - \frac{c}{2}]^4 - (1 -c)^4 \\
& = \left(\frac{1}{2}\right)^4(2-c)^4 - (1-c)^4
\end{aligned}
$$
...
$$
\begin{aligned}
P_W & = \left(\frac{1}{2}\right)^n(2-c)^n - (1-c)^n
\end{aligned}
$$

What is the optimal value of the cutoff $c$? Let's take the derivative of $P_W$
with respect to $c$, and see what cutoff will maximize our chances.

$$ 
\begin{aligned}
P_W & = \left(\frac{1}{2}\right)^n(2-c)^n - (1-c)^n \\
\frac{dP}{dc} & =  \left(\frac{1}{2}\right)^n \cdot n (2-c)^{n-1}(-1) - n(1-c)^{n-1}(-1) \\
