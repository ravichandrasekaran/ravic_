...
\\
E[D] & = \frac{8}{15}m + \frac{1}{2} - \frac{1}{30n^3} \\
& \approx \frac{8}{15}m + \frac{1}{2}
\end{aligned}
$$

So, with more faces, we have a linear expression for disadvantage-of-advantage,
and for a straight role. With each additional face, the edge that we get from 
using disadvantage-of-advantage grows linearly.
